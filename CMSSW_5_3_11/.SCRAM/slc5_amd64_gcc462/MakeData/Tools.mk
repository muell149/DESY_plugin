...
boost             := boost
ALL_TOOLS      += boost
boost_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_header_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_python_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/boost/1.47.0/include
...
bz2lib             := bz2lib
ALL_TOOLS      += bz2lib
bz2lib_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/bz2lib/1.0.5/include
...
cascade_headers_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/cascade/2.2.04-cms2/include
...
charybdis             := charybdis
ALL_TOOLS      += charybdis
charybdis_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/charybdis/1.003-cms2/include
...
classlib             := classlib
ALL_TOOLS      += classlib
classlib_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/classlib/3.1.3-cms3/include
...
clhep             := clhep
ALL_TOOLS      += clhep
clhep_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/clhep/2.0.4.6/include
...
clhepheader_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/clhep/2.0.4.6/include
...
cppunit             := cppunit
ALL_TOOLS      += cppunit
cppunit_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/cppunit/1.12.1/include
...
curl             := curl
ALL_TOOLS      += curl
curl_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/curl/7.21.6/include
...
db4             := db4
ALL_TOOLS      += db4
db4_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/db4/4.4.20/include
...
dcap             := dcap
ALL_TOOLS      += dcap
dcap_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/dcap/2.47.5.0-cms/include
...
dpm             := dpm
ALL_TOOLS      += dpm
dpm_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/dpm/1.8.0.1/include
dpm_EX_INCLUDE  := $(dpm_LOC_INCLUDE)
dpm_LOC_LIB := dpm
dpm_EX_LIB  := $(dpm_LOC_LIB)
dpm_LOC_LIBDIR := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/dpm/1.8.0.1/lib
...
evtgenlhc             := evtgenlhc
ALL_TOOLS      += evtgenlhc
evtgenlhc_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/evtgenlhc/9.1
...
fastjet             := fastjet
ALL_TOOLS      += fastjet
fastjet_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/fastjet/3.0.1-cms2/include
...
fftjet             := fftjet
ALL_TOOLS      += fftjet
fftjet_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/fftjet/1.3.1-cms/include
...
fftw3             := fftw3
ALL_TOOLS      += fftw3
fftw3_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/fftw3/3.2.2-cms/include
...
frontier_client_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/frontier_client/2.8.5/include
...
gdbm             := gdbm
ALL_TOOLS      += gdbm
gdbm_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/gdbm/1.8.3/include
...
geant4core_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/geant4/9.4.p03-cms/include
...
gsl             := gsl
ALL_TOOLS      += gsl
gsl_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/gsl/1.10/include
...
hector             := hector
ALL_TOOLS      += hector
hector_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/hector/1_3_4-cms40/include
...
herwig             := herwig
ALL_TOOLS      += herwig
herwig_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/herwig/6.521/include
...
jemalloc             := jemalloc
ALL_TOOLS      += jemalloc
jemalloc_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/jemalloc/2.2.2/include
...
jimmy_headers_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/jimmy/4.2-cms3/include
...
ktjet             := ktjet
ALL_TOOLS      += ktjet
ktjet_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/ktjet/1.06/include
...
lhapdf             := lhapdf
ALL_TOOLS      += lhapdf
lhapdf_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/lhapdf/5.8.5-cms2/include
...
libhepml             := libhepml
ALL_TOOLS      += libhepml
libhepml_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/libhepml/0.2.1/interface
...
libjpg             := libjpg
ALL_TOOLS      += libjpg
libjpg_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/libjpg/8b/include
...
libpng             := libpng
ALL_TOOLS      += libpng
libpng_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/libpng/1.2.46/include
...
libungif             := libungif
ALL_TOOLS      += libungif
libungif_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/libungif/4.1.4/include
...
llvm             := llvm
ALL_TOOLS      += llvm
llvm_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/llvm/3.2/include
...
mcdb             := mcdb
ALL_TOOLS      += mcdb
mcdb_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/mcdb/1.0.2/interface
...
meschach             := meschach
ALL_TOOLS      += meschach
meschach_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/meschach/1.2.pCMS1/include
...
mimetic             := mimetic
ALL_TOOLS      += mimetic
mimetic_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/mimetic/0.9.6/include
...
openssl             := openssl
ALL_TOOLS      += openssl
openssl_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/openssl/0.9.8e/include
...
oracle             := oracle
ALL_TOOLS      += oracle
oracle_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/oracle/11.2.0.3.0__10.2.0.4.0/include
...
pcre             := pcre
ALL_TOOLS      += pcre
pcre_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/pcre/7.9/include
...
protobuf             := protobuf
ALL_TOOLS      += protobuf
protobuf_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/protobuf/2.4.1/include
...
pythia8             := pythia8
ALL_TOOLS      += pythia8
pythia8_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/pythia8/153-cms2/include
...
python             := python
ALL_TOOLS      += python
python_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/python/2.6.4/include/python2.6
...
qt             := qt
ALL_TOOLS      += qt
qt_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/QtOpenGL /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/QtGui
...
qt3support_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/Qt3Support
...
qtbase             := qtbase
ALL_TOOLS      += qtbase
qtbase_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/Qt /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/QtCore /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/qt/4.6.3/include/QtXml
...
roofitcore_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/lcg/roofit/5.32.03-cms16/include
...
root_interface_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/lcg/root/5.32.00-cms21/include
...
rootcint             := rootcint
ALL_TOOLS      += rootcint
rootcint_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/lcg/root/5.32.00-cms21/cint
...
sherpa             := sherpa
ALL_TOOLS      += sherpa
sherpa_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/sherpa/1.4.2/include/SHERPA-MC
...
sigcpp             := sigcpp
ALL_TOOLS      += sigcpp
sigcpp_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/sigcpp/2.2.10/include/sigc++-2.0
...
sqlite             := sqlite
ALL_TOOLS      += sqlite
sqlite_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/sqlite/3.6.23/include
...
tauola_headers_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/tauola/27.121.5/include
...
thepeg             := thepeg
ALL_TOOLS      += thepeg
thepeg_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/thepeg/1.7.0-cms7/include
...
tkonlinesw_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/tkonlinesw/2.7.0-cms9/include
...
uuid             := uuid
ALL_TOOLS      += uuid
uuid_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/uuid/1.38/include
...
xdaq             := xdaq
ALL_TOOLS      += xdaq
xdaq_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/xdaq/VR17173/include /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/xdaq/VR17173/include/linux
...
xerces-c             := xerces-c
ALL_TOOLS      += xerces-c
xerces-c_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/xerces-c/2.8.0/include
...
xz             := xz
ALL_TOOLS      += xz
xz_LOC_INCLUDE := /pscratch/osg/app/cmssoft/cms/slc5_amd64_gcc462/external/xz/5.0.3-cms/include
