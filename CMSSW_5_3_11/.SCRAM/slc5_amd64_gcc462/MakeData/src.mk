...
subdirs_src+=$(filter-out Documentation, src_RecoVertex src_JetMETCorrections src_FWCore src_RecoJets src_TopQuarkAnalysis src_RecoBTag src_SusyAnalysis src_RecoTauTag src_TopAnalysis src_ElectroWeakAnalysis src_PhysicsTools src_DataFormats src_AnalysisDataFormats src_BEAN src_CommonTools src_CMGTools src_CondFormats src_RecoParticleFlow src_Muon src_EGamma)
